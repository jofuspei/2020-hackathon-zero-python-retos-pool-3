...
def mayus(update, context):
        #
        return update.message.reply_text(' '.join(context.args).upper())
...
def main():
    ...
    updater = Updater("1181213813:AAHWNXrQnmYQ1wriw8q1aRYdCUSdM0uTQEA", use_context=True)
    ...
    dp.add_handler(MessageHandler(Filters.command, alreves))
